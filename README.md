...
Есть немного доменной логики, особенно с hh.ru, чтобы работу с ним потянули довольно слабые модели на уровне gpt-4.1.
...
AGENT_MAX_STEPS=70
AGENT_SLOW_MO_MS=90
AGENT_CONTEXT_RESET_EVERY_STEPS=14
AGENT_MODEL_TOOL_OUTPUT_MAX_CHARS=6000
